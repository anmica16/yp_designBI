            ...
            refresh(callback) {
                ...
                Ywp.request({
                    ...
                    OnSuccess(result) {
                        ...
                        let Yw = window.Yw, newItemsCount = 0, newItems = [],
                            newItemsKeys = {},
                        ...
                        Yw.each(theItems, function (item) {
                            ...
                            if (!newItemsKeys[item.$key]) {
                                newItemsKeys[item.$key] = true;
                                newItems.push(item);
                            }
                        });
                        // me.newItems = newItems;
                        //# 3 新消息加入，旧消息当前不删
                        me.items = newItems;// me.newItems.concat(me.items); //theItems;
